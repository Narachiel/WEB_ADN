...
export default function AboutPage() {
  ...
  const values = [
    {
      title: "Excellence",
      description: "We strive for excellence in everything we do, from our solutions to our customer service. Our commitment to quality drives continuous improvement and innovation in our security solutions.",
      icon: (
        <svg className="w-12 h-12 text-[var(--sky-blue)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      title: "Innovation",
      description: "Continuously evolving our solutions to stay ahead of emerging threats. We invest heavily in R&D to develop cutting-edge security technologies and methodologies.",
      icon: (
        <svg className="w-12 h-12 text-[var(--sky-blue)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      title: "Integrity",
      description: "Operating with transparency and honesty in all our business dealings. We build trust through clear communication and ethical practices in everything we do.",
      icon: (
        <svg className="w-12 h-12 text-[var(--sky-blue)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      title: "Partnership",
      description: "Building long-term relationships with our clients based on trust and mutual success. We consider ourselves an extension of our clients' security teams.",
      icon: (
        <svg className="w-12 h-12 text-[var(--sky-blue)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="bg-gray-800/50 backdrop-blur-lg rounded-2xl p-8 border border-gray-700">
              <h2 className="text-3xl font-bold mb-6 bg-gradient-to-r from-blue-400 to-teal-400 text-transparent bg-clip-text">
                Our Mission
              </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              <div key={index} className="bg-gray-800/50 backdrop-blur-lg rounded-2xl p-6 border border-gray-700 hover:border-cyan-500/50 transition-all duration-300">
                <div className="w-14 h-14 mb-6 rounded-xl bg-gradient-to-r from-blue-500 via-cyan-500 to-teal-500 p-3 text-white">
                  {value.icon}
                </div>
            ...
            {teamMembers.map((member, index) => (
              <div key={index} className="bg-gray-800/50 backdrop-blur-lg rounded-2xl p-6 border border-gray-700 hover:border-cyan-500/50 transition-all duration-300">
                <PlaceholderImage
                  ...
                  height={400}
                  text={member.name}
                  className="w-32 h-32 mx-auto rounded-full mb-6 overflow-hidden"
                  bgClassName="bg-gradient-to-r from-blue-500 via-cyan-500 to-teal-500"
                />
                <div className="text-center">
                  <h3 className="text-xl font-bold mb-1 bg-gradient-to-r from-blue-400 to-teal-400 text-transparent bg-clip-text">
                    {member.name}
                  </h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {milestones.map((milestone, index) => (
              <div key={index} className="bg-gray-800/50 backdrop-blur-lg rounded-2xl p-6 border border-gray-700 hover:border-cyan-500/50 transition-all duration-300">
                <div className="text-3xl font-bold mb-3 bg-gradient-to-r from-blue-400 to-teal-400 text-transparent bg-clip-text">
                  {milestone.year}
                </div>
                <h3 className="text-lg font-semibold mb-2 text-cyan-400">{milestone.title}</h3>
